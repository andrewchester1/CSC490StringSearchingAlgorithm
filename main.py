    ...
    for i in range(n - m + 1):
        ...
        while k < m:
            if text[i + k] == pattern[k]:
                ...
                break
        # if k == m:
        #     print("BrutalForce: Pattern found at index ", i)
...
def KMP(text, pattern):
    ...
    while i < n - m + 1:
        ...
        #     print("KMP: Pattern found at index ", i)
        i += dict["next"]
...
print('Brutal Force', timeit.Timer(timeBrutalForce).timeit(number=10))
print('JMP', timeit.Timer(timeKMP).timeit(number=10))
print('Trie', timeit.Timer(timeTrie).timeit(number=10))